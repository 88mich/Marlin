...
namespace Language_it {
  ...
  PROGMEM Language_Str MSG_FILAMENTCHANGE                  = _UxGT("Cambia filam.");
  PROGMEM Language_Str MSG_FILAMENTCHANGE_E                = _UxGT("Cambia filam. *");
  PROGMEM Language_Str MSG_FILAMENTLOAD                    = _UxGT("Carica filam.");
  PROGMEM Language_Str MSG_FILAMENTLOAD_E                  = _UxGT("Carica filam. *");
  PROGMEM Language_Str MSG_FILAMENTUNLOAD                  = _UxGT("Rimuovi filam.");
